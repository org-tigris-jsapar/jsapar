...
public abstract class SchemaCell implements Cloneable {
    ...
    /**
     * Creates a cell with a parsed value according to the schema specification
     * for this cell.
     * 
     * @param sValue
    ...
    /**
     * Validates that the cell value is within the valid range. Throws a
     * SchemaException if value is not within borders.
     * 
     * @param cell
     * @throws SchemaException
     */
	...
	/*
	 * if (this.minValue != null && cell.compareTo(this.minValue) < 0) throw
	 * new SchemaException("The value is below minimum range limit."); else
	 * if (this.maxValue != null && cell.compareTo(this.maxValue) > 0) throw
	 * new SchemaException("The value is above maximum range limit.");
	 */
    }
