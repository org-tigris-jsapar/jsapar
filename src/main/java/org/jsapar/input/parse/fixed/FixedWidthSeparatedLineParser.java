...
public class FixedWidthSeparatedLineParser extends SchemaLineParser {
    ...
    /* (non-Javadoc)
     * @see org.jsapar.input.parse.SchemaLineParser#parse(long, org.jsapar.input.ParsingEventListener)
     */
    @Override
    public boolean parse(long nLineNumber, ParsingEventListener listener) throws IOException, JSaParException {
