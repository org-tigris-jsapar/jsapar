...
public class JavaBeanFactoryDefault implements JavaBeanFactory {
    private static final String GET_PREFIX = "get";
    private static final String SET_PREFIX = "set";

    public JavaBeanFactoryDefault() {
    }

    /**
     * This implementation creates the bean by using Class.forName method on the line type.
     * @see org.jsapar.output.JavaBeanFactory#createBean(org.jsapar.Line)
     */
    @Override
     ...
     * @see org.jsapar.output.JavaBeanFactory#findOrCreateChildBean(java.lang.Object, java.lang.String)
     */
    @Override
