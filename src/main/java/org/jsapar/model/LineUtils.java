...
public class LineUtils {
     ...
     */
    private static Cell getExistingCell(Line line, String cellName) throws JSaParException {
        Cell cell = line.getCell(cellName);
        if (cell == null)
    ...
    public static int getIntCellValue(Line line, String cellName) throws IllegalStateException, NumberFormatException {
        ...
        if(cell.isEmpty())
            throw new NumberFormatException("The cell ["+cell+"] does not have a value and thus cannot be parsed into an integer value.");
     ...
     * @throws NumberFormatException If the cell could not be converted into an integer value
     */
    public static long getLongCellValue(Line line, String cellName) throws JSaParException, NumberFormatException {
        Cell cell = getExistingCell(line, cellName);
        if (cell instanceof NumberCell) {
            NumberCell numberCell = (NumberCell) cell;
     ...
     * @throws NumberFormatException If the cell could not be converted into an integer value
     */
    public static char getCharCellValue(Line line, String cellName) throws JSaParException, NumberFormatException {
        Cell cell = getExistingCell(line, cellName);
     ...
     */
    public static Date getDateCellValue(Line line, String cellName) throws IllegalStateException, NumberFormatException {
        Cell cell = getExistingCell(line, cellName);
     ...
     */
    public static <E extends Enum<E>> E getEnumCellValue(Line line, String cellName, Class<E> enumClass) throws JSaParException, IllegalArgumentException {
        Cell cell = getExistingCell(line, cellName);
        String s = cell.getStringValue();
    ...
    public static <E extends Enum<E>> E getEnumCellValue(Line line, String cellName, E defaultValue) throws IllegalArgumentException {
        Cell cell = line.getCell(cellName);
        if(cell == null || cell.isEmpty())
            return defaultValue;
     ...
     */
    public static double getDoubleCellValue(Line line, String cellName) throws IllegalStateException, NumberFormatException {
        Cell cell = getExistingCell(line, cellName);
        if (cell instanceof NumberCell) {
            NumberCell numberCell = (NumberCell) cell;
     ...
     * @throws JSaParException
     */
    public static double getDoubleCellValue(Line line, String cellName, double defaultValue) throws NumberFormatException {
        Cell cell = line.getCell(cellName);
        if(cell == null || cell.isEmpty())
            return defaultValue;
     ...
     *             , NumberFormatException
     */
    public static BigDecimal getDecimalCellValue(Line line, String cellName) throws JSaParException, NumberFormatException {
        Cell cell = getExistingCell(line,cellName);
     ...
     *             , NumberFormatException
     */
    public static BigDecimal getDecimalCellValue(Line line, String cellName, BigDecimal defaultValue) throws NumberFormatException  {
        Cell cell = line.getCell(cellName);
        if (cell == null || cell.isEmpty())
            return defaultValue;
     ...
     *             , NumberFormatException
     */
    public static BigInteger getBigIntegerCellValue(Line line, String cellName) throws JSaParException, NumberFormatException {
        Cell cell = getExistingCell(line,cellName);
        if (cell instanceof BigDecimalCell) {
            BigDecimalCell numberCell = (BigDecimalCell) cell;
     ...
     *             , NumberFormatException
     */
    public static BigInteger getBigIntegerCellValue(Line line, String cellName, BigInteger defaultValue) throws NumberFormatException {
        Cell cell = line.getCell(cellName);
        if(cell == null || cell.isEmpty())
            return defaultValue;
