...
/**
 * Class containging the cell dateValue as a string representation. Each line
...
public class DateCell extends Cell implements Comparable<DateCell> {
	private final static java.text.DateFormat xmlDateFormat = new java.text.SimpleDateFormat(
	...
	public DateCell(String name, String value, Format format)
	...
	public String getXmlValue() {
		...
		return sTime.substring(0, sTime.length() - 2) + ":"
				+ sTime.substring(sTime.length() - 2, sTime.length());
	}
	...
	public void setValue(String value, Locale locale) throws ParseException {
		this.dateValue = DateFormat.getDateInstance(DateFormat.SHORT, locale)
				.parse(value);
	}
