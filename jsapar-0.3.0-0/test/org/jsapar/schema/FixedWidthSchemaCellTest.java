...
public class FixedWidthSchemaCellTest {
	...
	FixedWidthSchemaCell schemaElment = new FixedWidthSchemaCell(
		"First name", 11);

	Reader reader = new StringReader(toParse);
	Cell cell = schemaElment.build(reader, true, ' ');
	...
	String toParse = "           ";
	FixedWidthSchemaCell schemaElement = new FixedWidthSchemaCell(
		"First name", 11);
	...
	Reader reader = new StringReader(toParse);
	Cell cell;
	cell = schemaElment.build(reader, true, ' ');
    ...
    /**
     * A cell should not be considerede empty if blanks are not removed by
     * trimming.
     */
    @Test
    public final void testBuildEmptyMandatoryNoTrim() throws IOException,
	    Exception {
	String toParse = "           ";
	FixedWidthSchemaCell schemaElement = new FixedWidthSchemaCell(
		"First name", 11);
	...
	Reader reader = new StringReader(toParse);
	Cell cell;
	cell = schemaElement.build(reader, false, ' ');
    ...
    @Test
    public final void testBuild_date() throws IOException, JSaParException,
	    SchemaException {
	String toParse = "2007-04-10 16:15";
	FixedWidthSchemaCell schemaElment = new FixedWidthSchemaCell("Date", 16);
	schemaElment.setCellFormat(new SchemaCellFormat(CellType.DATE,
		"yyyy-MM-dd HH:mm"));

	Reader reader = new StringReader(toParse);
	DateCell cell = (DateCell) schemaElment.build(reader, true, ' ');
    ...
    public final void testBuild_decimal_sv() throws IOException,
	    JSaParException, SchemaException {
	String toParse = "-123 456,78  ";
	FixedWidthSchemaCell schemaElment = new FixedWidthSchemaCell("Decimal",
		11);
	...
	Reader reader = new StringReader(toParse);
	BigDecimalCell cell = (BigDecimalCell) schemaElment.build(reader, true,
		' ');
    ...
    @Test
    public final void testBuild_decimal_uk() throws IOException,
	    JSaParException, SchemaException {
	String toParse = "-123,456.78  ";
	FixedWidthSchemaCell schemaElment = new FixedWidthSchemaCell("Decimal",
		11);
	...
	FixedWidthSchemaCell schemaElment = new FixedWidthSchemaCell("Integer",
		6);
	...
	Reader reader = new StringReader(toParse);
	BooleanCell cell = (BooleanCell) schemaElment.build(reader, true, ' ');
	...
	FixedWidthSchemaCell schemaCell = new FixedWidthSchemaCell(
		"First name", 11);
	...
	Reader reader = new StringReader(toParse);
	Cell cell;
	cell = schemaCell.build(reader, true, ' ');
